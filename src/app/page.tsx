      ...
      <header className="sticky top-0 z-10 bg-background border-b border-border px-4 py-3">
        ...
        <div className="flex flex-wrap items-start gap-3">
          ...
          <p className="flex-1 min-w-[200px] text-sm text-foreground leading-snug">
            Select your name from the drop list to proceed. To sign up for a game, click on the table&apos;s cell. To remove your name click again. To change the time of a game, click/tap the Time cell for that game. If your name is not on the list, text or call Dori <a href="tel:+19734934959" className="text-primary font-medium whitespace-nowrap">973&nbsp;493-4959</a>.
          </p>
        </div>
      </header>
        ...
        <div className="mx-4 mt-2 border border-border rounded-lg bg-card p-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              title="Submit your PIN to unlock admin features"
            >
              OK
            </button>
            <button
              ...
              title="Continue as a regular player without admin access"
            >
              Skip
            </button>
          </div>
